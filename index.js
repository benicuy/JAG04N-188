...
document.getElementById('login').addEventListener('submit', function(e) {
    ...
    if (user) {
        ...
        // Tampilkan provider jika social login
        if (user.authProvider && user.authProvider !== 'local') {
            document.getElementById('providerBadge').style.display = 'inline';
            document.getElementById('providerBadge').textContent = user.authProvider;
        }
